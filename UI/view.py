...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self.numDay = ft.TextField(label="num Giorni")
        ...
        self.btn_analizza = ft.ElevatedButton(text='Analizza', on_click=self.controller.handle_analizza,
                                              disabled=True)
        row2 = ft.Row([self.ddstate, self.btn_analizza], alignment=ft.MainAxisAlignment.CENTER)
        ...
        self.minCity = ft.TextField(label='min città')
        self.maxD = ft.TextField(label='max distanza')
        self.ddTarget = ft.Dropdown(label='partenza')
